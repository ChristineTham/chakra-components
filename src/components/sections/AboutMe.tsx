...
export const AboutMe: React.FC = () => {
  ...
  const link = useColorModeValue('purple.600', 'purple.400')
  const icon = useColorModeValue('gray.700', 'gray.200')
  const hover = useColorModeValue('gray.600', 'gray.400')
      ...
      <Box px={6} py={8} mx="auto" bgColor={bg}>
        <Box display={{ lg: 'flex' }} alignItems="center">
          <Box width={{ lg: 1 / 2 }}>
            ...
            <Text color={text} maxW={{ lg: 'md' }} mt={4}>
              Hi I am jane, software engineer{' '}
              <Link color={link} fontWeight="bold" href="#">
                @BakaTeam
              </Link>
          ...
          <Box mt={{ base: 8, large: 0 }} width={{ lg: 1 / 2 }}>
